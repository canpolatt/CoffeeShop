...
public class RGPKPSPublicSoap
{
    ...
    public RGPKPSPublicSoap(){}

    public RGPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RGPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RGPExtendedSoapSerializationEnvelope envelope= new RGPExtendedSoapSerializationEnvelope(RGPExtendedSoapSerializationEnvelope.VER11);
