...
public class RGPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RGPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RGPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RGPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RGPDateTimeConverter dateTimeConverter = new RGPStandardDateTimeConverter();

    public RGPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RGPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RGPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RGPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RGPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RGPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
